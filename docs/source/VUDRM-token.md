...
| `session`          | JSON     | (See below)[#drm-session-in-policy] | ALL | A JSON object containing information about a DRM session that can be used to allow/deny a users license requests.
