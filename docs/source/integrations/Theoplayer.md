...
The following instructions demonstrate how to use [vudrm](https://docs.vualto.com/projects/vudrm/en/latest/index.html) with [THEOplayer](https://www.theoplayer.com/).

If you have any questions please contact support@vualto.com

These instructions are currently targeted at THEOplayer version 2.51.1
