...
The request to the Studio DRM token API needs to be a POST and requires an `x-api-key` header with your account API key as the value. Please contact support@vualto.com if you do not have this.
