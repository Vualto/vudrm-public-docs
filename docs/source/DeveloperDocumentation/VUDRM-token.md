...
| Key                        | Type                    | Format            | Description
|----------------------------|-------------------------|-------------------|-------------
| `rental_duration_seconds`  | int                     | Seconds           | Setting this value will cause the When using the will continue after license expiry until the encryption keys change. offline
